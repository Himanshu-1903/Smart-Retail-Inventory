 ...
 * by querying user_roles → role_permissions → permissions JOIN chain.
 *
 * @param  {...string} requiredPermissions - Permission names the user must have
 * @returns {Function} Express middleware function
 *
 * Usage:
 *   router.get('/products', authenticate, authorize('products.read'), controller.getAll);
 *   router.delete('/products/:id', authenticate, authorize('products.delete', 'products.read'), controller.delete);
 */
