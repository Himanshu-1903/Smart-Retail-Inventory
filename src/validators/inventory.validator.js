...
/**
 * Validation rules for adjusting inventory (manual stock adjustment).
 */
const adjust = [
  body('product_id')
    .notEmpty()
...
/**
 * Validation rules for reorder request.
 */
const reorder = [
  body('product_id')
    .notEmpty()
...
/**
 * Validation rules for stock transfer between warehouses.
 */
const transfer = [
  body('product_id')
    .notEmpty()
